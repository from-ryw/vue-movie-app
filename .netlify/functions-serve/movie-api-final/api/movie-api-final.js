...
// api/movie-api-final.cjs
var fetch = require_lib2();
exports.handler = async function(event) {
  const { title, page, id } = JSON.parse(event.body);
  const { OMDB_API_KEY } = process.env;
  const url = id ? `https://www.omdbapi.com/?apikey=${OMDB_API_KEY}&i=${id}&plot=full` : `https://www.omdbapi.com/?apikey=${OMDB_API_KEY}&s=${title}&page=${page}`;
...
//# sourceMappingURL=movie-api-final.js.map
